...
MapboxGL.setAccessToken('pk.eyJ1IjoibW5peGlzIiwiYSI6ImNseHB4bGR4ZjBsc2YycXNlNG9jbDd5MnMifQ.EUpXwPaDeJNHUZ1WVhOmNQ');

const breezoApiKey = 'AIzaSyDLFaR2k9bsXNxCbc78Rjhiy-Mfz7jxQPU'; // BreezoMeter API Key
